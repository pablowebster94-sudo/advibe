...
import {properties as demoProperties,vehicles as demoVehicles} from "@/lib/enfoque-data";
import {getPublishedProperties,getPublishedVehicles,supabaseConfigured} from "@/lib/enfoque-supabase";
