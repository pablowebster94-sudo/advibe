...
import GoatOutro from "@/components/GoatOutro";
...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-[#070808] text-white">
      <StickyDesktopCTA />
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 rounded-t-3xl border border-white/10 border-b-0 bg-[#070808]/95 px-4 py-4 shadow-[0_-15px_50px_-35px_rgba(0,0,0,0.65)] backdrop-blur-xl">
          <div><p className="text-xs uppercase tracking-[0.28em] text-[#78dcd1]">Diagnóstico gratuito</p><p className="text-sm font-semibold text-white">Descubre oportunidades</p></div>
          <EventButton href="#diagnostico" eventName="request_diagnostic" eventParams={{ source: "mobile_cta" }} className="inline-flex items-center justify-center rounded-full bg-[#f5f2ea] px-5 py-3 text-sm font-semibold text-[#080909]">Analizar mi marca</EventButton>
        </div>
      </div>
