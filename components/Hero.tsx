...
// La cabra definitiva debe vivir en /public/images/goat-advibe.webp.
// Se usa una ruta local para evitar imágenes rotas por URLs externas o archivos inexistentes.
