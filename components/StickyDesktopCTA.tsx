        ...
        <motion.div initial={{ y: -80, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -80, opacity: 0 }} className="fixed inset-x-0 top-0 z-[48] hidden md:block">
          <div className="border-b border-white/10 bg-[#050505]/92 shadow-[0_4px_32px_-8px_rgba(0,0,0,0.6)] backdrop-blur-xl">
            <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-3">
              ...
              <div className="flex items-center gap-3">
                <a href="https://wa.me/593984966335?text=Hola,%20quiero%20un%20diagn%C3%B3stico%20gratuito" target="_blank" rel="noreferrer" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold text-white hover:bg-white/10">
                  WhatsApp
                </a>
