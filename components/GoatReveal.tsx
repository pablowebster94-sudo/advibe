    ...
    <section aria-label="Cierre AdVibe" className="relative overflow-hidden bg-[#050505] py-20 sm:py-28">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6">
        <div className="relative min-h-[500px] overflow-hidden rounded-[2rem] border border-white/10 bg-[#07100b] sm:min-h-[560px]">
          ...
          <motion.div initial={{ opacity: 0, y: 120, scale: 0.96 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 1.1, ease: [0.22, 1, 0.36, 1] }} className="absolute bottom-0 right-[-2%] z-10 w-[58%] max-w-[500px] sm:right-[1%] sm:w-[52%]">
