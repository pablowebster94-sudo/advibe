      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-3">
        <div>
          ...
          <p className="mt-6 max-w-sm leading-8 text-slate-400">
            Ayudamos a empresas a crecer mediante estrategia, creatividad y tecnología.
          </p>
          <p className="mt-6 text-sm text-slate-500">Gualaceo · Azuay · Ecuador</p>
        </div>
        ...
        <div>
          ...
          <div className="mt-6 space-y-4">
            {links.map((link) => (
              <a key={link.label} href={link.href} className="block text-slate-400 transition hover:text-lime-300">
                {link.label}
              </a>
            ))}
          </div>
