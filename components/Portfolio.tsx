  ...
  return (
    <section id="portafolio" className="relative overflow-hidden bg-[#05070a] py-28 sm:py-32 lg:py-40">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading eyebrow="02 / Trabajo real" title="Ideas que salieron del estudio y llegaron al mercado." description="Una selección de proyectos reales de AdVibe. Estrategia, creatividad, contenido y performance aplicados a objetivos concretos." />
          ...
          {projects.map((project) => (
            <article key={project.title} className="group relative border-b border-white/10 last:border-b-0">
              <div className="grid min-h-[300px] lg:grid-cols-[92px_1.15fr_0.85fr]">
                <div className="hidden border-r border-white/10 p-7 lg:block"><span className="font-mono text-xs text-lime-300">{project.number}</span></div>
                <div className="relative overflow-hidden p-7 sm:p-10 lg:p-12">
                  ...
                  <div className="relative flex h-full flex-col justify-between">
                    <div className="flex items-center justify-between"><span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-slate-500">{project.sector}</span><span className="font-mono text-xs text-white/25 lg:hidden">{project.number}</span></div>
